...
- Related files: [configs/visual.config.ts](configs/visual.config.ts) & [tests/visual](tests/visual) folder. _Note: The only changes in the config are turning video & screenshots off & updating the test directory._
